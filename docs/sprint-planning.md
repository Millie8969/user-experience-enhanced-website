...
Als je dat nog niet hebt en je hebt hier nog geen issues voor, maak dan een nieuwe aan, bijvoorbeeld: "UI-stack states POST interactie". Hier kan je deze sprint mooi aan doorwerken. 
